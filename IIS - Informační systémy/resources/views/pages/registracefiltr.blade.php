        ...
        <tbody>
            @foreach($termins as $termin) 
                <tr>
                    ...
                    @switch($termin->den)
                    @case(1)
                    <td class="tg-0lax" height="50"><b>Pondeli</b></td>
                        @break
                    @case(2)
                    <td class="tg-0lax" height="50"><b>Utery</b></td>
                        @break
                    @case(3)
                    <td class="tg-0lax" height="50"><b>Streda</b></td>
                        @break
                    @case(4)
                    <td class="tg-0lax" height="50"><b>Ctvrtek</b></td>
                        @break
                    @case(5)
                    <td class="tg-0lax" height="50"><b>Patek</b></td>
                        @break
                @endswitch
