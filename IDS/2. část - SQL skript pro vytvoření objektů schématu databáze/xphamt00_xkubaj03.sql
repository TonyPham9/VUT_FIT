/*Tato Ë·st vytv·¯Ì sekvence pro poËÌt·nÌ PK*/
...
/*Tato Ë·st vytv·¯Ì tabulky a relace mezi tabulkami*/
CREATE TABLE Klient (
...
/*Zde se vkl·dajÌ data*/

INSERT INTO zamestnanec values( ID_zamestnance_seq.nextval,'Frantiöek', 'Vom·Ëka', DATE '1998-12-05','Brno', 420666353, 'vomFrant@gmail.com');
...
INSERT INTO zamestnanec values( ID_zamestnance_seq.nextval,'Stanislav', 'Prav·k', DATE '1999-05-16','HavlÌËk˘v Brod', 123123123, 'stanik88@seznam.cz');
INSERT INTO zamestnanec values( ID_zamestnance_seq.nextval,'Libor', 'LaviËka', DATE '2002-06-19','Praha', 976776876, 'libor.lavicka@gmail.com');
INSERT INTO zamestnanec values( ID_zamestnance_seq.nextval,'Lojza', 'KomÌn', DATE '2001-07-21','Svitavy', 722656879, 'milujuqueeny@gmail.com');

INSERT INTO Klient values( ID_klienta_seq.nextval,'Boris', 'Paötika', DATE '2003-03-28');
INSERT INTO Klient values( ID_klienta_seq.nextval,'Filip', 'Vrzal', DATE '1986-09-29');
INSERT INTO Klient values( ID_klienta_seq.nextval,'Radek', 'MatÏjka', DATE '1969-02-13');
...
INSERT INTO Doplnky values( ID_doplnku_seq.nextval,'Klobouk s pe¯Ìm', 'Nike', 'satÈn', 'V˝born˝ pro divadelnÌ hry', 2000, 'A', 5,(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=2));
INSERT INTO Doplnky values( ID_doplnku_seq.nextval,'ä·la s n·öivkou', NULL, 'vlna', NULL, 500, 'A', 2,(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=3));
INSERT INTO Doplnky values( ID_doplnku_seq.nextval,'Skautsk˝ ö·tek', NULL, 'bavlna', NULL, 350, 'A', 3,(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=4));
INSERT INTO Doplnky values( ID_doplnku_seq.nextval,'Slepeck· h˘l', NULL, 'hlinÌk', NULL, 800, 'N', 1,(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=5));
...
INSERT INTO Kostym values( ID_kostymu_seq.nextval, 'Carmen', 'Andrie', 'Nylon', 'DivadelnÌ kost˝m', 3000.0, 'S', 'A', 'Ëerven·', 7 , 'Zachoval˝',(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=1));
INSERT INTO Kostym values( ID_kostymu_seq.nextval, 'SuknÏ', 'Andrie', 'Bavlna', 'Jednoduch· dlouh· skunÏ', 1200.0, 'L', 'N', 'zelen·', 1 , 'Jako nov·',(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=1));
INSERT INTO Kostym values( ID_kostymu_seq.nextval, 'Kroj', NULL, 'Nylon', 'VyöÌvan˝ lidov˝ odÏv', 3500, 'M', 'A', 'zelen·', 2 , 'Pouûit˝',(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=2));
INSERT INTO Kostym values( ID_kostymu_seq.nextval, 'Pl·öù', NULL,'Akryl', '»ern˝ pl·öù pro zlodÏje', 900.0, NULL, 'N', 'Ëern·', 3 , 'Jako nov·',(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=3));
INSERT INTO Kostym values( ID_kostymu_seq.nextval, 'Sako', 'V˝voj', 'Nylon', '»ernÈ sako s jemn˝mi pruhy', 1100.0, 'L', 'A', 'svÏtle Ëern·', 4 , 'Pouûit˝',(SELECT ID_zamestnance from Zamestnanec WHERE ID_zamestnance=4));
...
INSERT INTO zaznam values( ID_zaznamu_seq.nextval, 1300, 'Halloween', DATE '2012-10-01','Lehce natrûenÈ', 3);
